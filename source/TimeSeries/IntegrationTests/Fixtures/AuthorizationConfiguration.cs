...
namespace Energinet.DataHub.TimeSeries.IntegrationTests.Fixtures
{
    ...
    public class AuthorizationConfiguration
    {
        public AuthorizationConfiguration()
        {
            ...
            var teamClientId = SecretsConfiguration.GetValue<string>(BuildB2CTeamSecretName(Environment, "joules", "client-id"));
            var teamClientSecret = SecretsConfiguration.GetValue<string>(BuildB2CTeamSecretName(Environment, "joules", "client-secret"));

            ClientCredentialsSettings = RetrieveB2CTeamClientSettings("joules", teamClientId, teamClientSecret);
