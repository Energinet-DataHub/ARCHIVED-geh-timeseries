...
def store_points_of_valid_time_series(batch_df: DataFrame, output_delta_lake_path, watch: MonitoredStopwatch):
    ...
    batch_df \
        ...
        .select(col("series_meteringPointId"),
                ...
                col("document_businessReasonCode").alias("businessReasonCode"),
                col("document_sender_businessProcessRole").alias("sender_type"),
                col("series_id"),
                ...
                col("document_industryClassification").alias("ServiceCategory_Kind"),
