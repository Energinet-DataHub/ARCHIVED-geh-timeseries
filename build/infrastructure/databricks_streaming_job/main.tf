...
data "azurerm_key_vault_secret" "evhar_receivedqueue_receiver_connection_string" {
...
module "streaming_job" {
  ...
  input_eventhub_listen_connection_string        = data.azurerm_key_vault_secret.evhar_receivedqueue_receiver_connection_string.value
