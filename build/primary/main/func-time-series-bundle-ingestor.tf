...
module "time_series_bundle_ingestor" {
  ...
  app_settings                              = {
    ...
    STORAGE_ACCOUNT_NAME                                = module.azurerm_key_vault_secret.st_data_lake_name.value
    STORAGE_CONNECTION_STRING                           = module.azurerm_key_vault_secret.kvs_st_data_lake_primary_connection_string.value
    STORAGE_KEY                                         = module.azurerm_key_vault_secret.kvs_st_data_lake_primary_access_key.value
    ...
    STORAGE_ACCOUNT_NAME = module.evh_received_timeseries
  }
